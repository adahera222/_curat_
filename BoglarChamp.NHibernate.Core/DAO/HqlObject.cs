...
namespace BoglarChamp.NHibernate.Core.DAO
{
    public class HqlObject
    {
        ...
        public HqlObject(string sqlBase)
        {
        ...
        public IList List(IList parameters)
        {
            ...
            try
            {
                ...
                q = nHibernateUtil.GetSession.CreateQuery(GetFullQuery(parameters));
                ret = q.List();
            }
            finally
            {
        ...
        public IList List()
        {
            ...
            try
            {
                q = nHibernateUtil.GetSession.CreateQuery(GetFullQuery());
        ...
        public IList ListMaxResults(int maxResults)
        {
            ...
            try
            {
                q = nHibernateUtil.GetSession.CreateQuery(GetFullQuery()).SetFirstResult(0).SetMaxResults(maxResults);
        ...
        public IList ListSimple()
        {
            ...
            try
            {
                q = nHibernateUtil.GetSession.CreateQuery(sqlBase);
        ...
        {
            int ret = 0;
            ret = nHibernateUtil.GetSession.Delete(GetFullQuery());
            return ret;
        }
    }
