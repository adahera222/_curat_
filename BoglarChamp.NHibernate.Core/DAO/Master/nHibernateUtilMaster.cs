...
{
    public class nHibernateUtilMaster
    {
        ...
        private static nHibernateUtilMaster _sessionFactory = new nHibernateUtilMaster();
        ...
        /// Default constructor.
        /// </summary>
        protected nHibernateUtilMaster()
        {
            LoadMappingFile();
            BuildSessionFactory();
        }
        ...
        private void LoadMappingFile()
        {
            try
            {
                ...
                _nhibernateConfiguration = config.Configure(path + @"\hibernateMaster.cfg.xml");
        ...
        private void BuildSessionFactory()
        {
            try
            {
                ...
                nHibernateUtilMaster._nhibernateFactory = _nhibernateConfiguration.BuildSessionFactory();
        ...
        {
            get { return nHibernateUtilMaster._nhibernateFactory; }
        }
