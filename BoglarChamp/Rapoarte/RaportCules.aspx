<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RaportCules.aspx.cs" Inherits="BoglarChamp.Rapoarte.RaportCules" %>
...
<body>
    ...
    <dxxr:ReportViewer ID="ReportViewer1" runat="server" 
        Report="<%# new BoglarChamp.Rapoarte.RaportMuncitor() %>" 
        ReportName="BoglarChamp.Rapoarte.RaportMuncitor">
    </dxxr:ReportViewer>
