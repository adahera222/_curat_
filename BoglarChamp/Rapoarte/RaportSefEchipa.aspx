<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RaportSefEchipa.aspx.cs" Inherits="BoglarChamp.Rapoarte.RaportSefiEchipa" %>
...
<body>
    ...
    <dxxr:ReportViewer ID="ReportViewer1" runat="server" 
        Report="<%# new BoglarChamp.Rapoarte.RaportSefEchipaR() %>" 
        ReportName="BoglarChamp.Rapoarte.RaportSefEchipaR">
    </dxxr:ReportViewer>
