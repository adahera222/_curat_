<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RaportSefiEchipa.aspx.cs" Inherits="BoglarChamp.Rapoarte.RaportSefiEchipa1" %>
...
<body>
    ...
    <dxxr:ReportViewer ID="ReportViewer1" runat="server" 
        Report="<%# new BoglarChamp.Rapoarte.RaportSefiEchipaR() %>" 
        ReportName="BoglarChamp.Rapoarte.RaportSefiEchipaR">
    </dxxr:ReportViewer>
