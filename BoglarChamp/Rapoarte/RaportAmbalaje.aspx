<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RaportAmbalaje.aspx.cs" Inherits="BoglarChamp.Rapoarte.RaportAmbalaje" %>
...
<body>
    ...
    <dxxr:ReportViewer ID="ReportViewer1" runat="server" 
        Report="<%# new BoglarChamp.Rapoarte.RaportAmbalajeR() %>" 
        ReportName="BoglarChamp.Rapoarte.RaportAmbalajeR">
    </dxxr:ReportViewer>
