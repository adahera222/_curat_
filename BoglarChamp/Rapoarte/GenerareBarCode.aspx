<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenerareBarCode.aspx.cs" Inherits="BoglarChamp.Rapoarte.GenerareBarCode" %>
...
<body>
    ...
    <dxxr:ReportViewer ID="ReportViewer1" runat="server" 
        Report="<%# new BoglarChamp.Rapoarte.BarCodeMuncitor() %>" 
        ReportName="BoglarChamp.Rapoarte.BarCodeMuncitor">
    </dxxr:ReportViewer>
